...
var Input = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-col", children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { htmlFor: id, className: "mb-1 font-medium", children: label }),
    ...
    error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "mt-1 text-sm text-red-500", children: error })
  ] });
};
