...
var Input = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-col pt-10", children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { htmlFor: id, className: "mb-1 text-sm font-bold text-gray-700", children: label.toUpperCase() }),
...
var Alert = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex-1", children: [
        text && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "font-semibold", children: text }),
        children && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: text ? "mt-1" : "", children })
      ] })
    }
  );
};
...
var AlertContainer = () => {
  const [alerts2, setAlerts] = import_react.default.useState([]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    ...
    {
      className: "\r\n        fixed\r\n        left-4\r\n        top-4\r\n        z-[99999]\r\n        flex\r\n        w-[380px]\r\n        max-w-[calc(100vw-2rem)]\r\n        flex-col\r\n        gap-3\r\n      ",
      children: alerts2.map((item) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Alert, { type: item.type, children: item.message }, item.id))
    }
  );
};
